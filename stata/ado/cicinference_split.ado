program define cicinference_split, rclass
    version 16.0

    /*
    Temporary split wrapper for migration tests only.
    ...
    */
    ...
    if (r(N) < 4) {
        display as error "split requires at least 4 complete observations"
        exit 2001
    }
